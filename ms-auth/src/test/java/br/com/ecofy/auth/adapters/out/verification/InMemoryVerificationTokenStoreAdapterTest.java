...
class InMemoryVerificationTokenStoreAdapterTest {
    ...
    private InMemoryVerificationTokenStoreAdapter createAdapter() {
        return new InMemoryVerificationTokenStoreAdapter();
    }
    ...
    private String invokeMaskToken(
        ...
        Method method =
                InMemoryVerificationTokenStoreAdapter.class
                        .getDeclaredMethod(
                                "maskToken",
                                String.class
                        );
