...
public record BudgetingProperties(
    ...
    public BudgetingProperties(Topics topics, Idempotency idempotency, Alerts alerts,
                               Schedulers schedulers, Scheduling scheduling) {
        this(topics, idempotency, alerts, schedulers, scheduling, null, null, null, null, null);
    }
