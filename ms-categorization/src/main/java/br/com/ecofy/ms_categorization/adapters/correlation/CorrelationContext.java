package br.com.ecofy.ms_categorization.adapters.correlation;
...
// Centraliza correlation ID e causation ID no MDC para propagação entre HTTP, Kafka e Outbox.
public final class CorrelationContext {

    // Define o header oficial de correlation ID usado em HTTP e Kafka.
    public static final String HEADER = "X-Correlation-Id";
    public static final String KAFKA_HEADER = HEADER;

    // Define o header Kafka que carrega o eventId da mensagem de entrada.
    ...
    // Resolve o valor recebido quando válido ou gera um novo, evitando propagar conteúdo inseguro.
    ...
    // Recupera o causation corrente, ou null quando não há mensagem em processamento.
    ...
    // Instala o contexto no MDC, devendo ser sempre pareado com a limpeza em finally.
