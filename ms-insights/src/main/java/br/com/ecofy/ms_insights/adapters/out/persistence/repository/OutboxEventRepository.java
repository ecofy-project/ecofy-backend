...
public interface OutboxEventRepository extends JpaRepository<OutboxEventEntity, UUID> {
    ...
    @Query("""
            select e
             ...
             where e.status = br.com.ecofy.ms_insights.core.domain.outbox.OutboxStatus.PENDING
                or (e.status = br.com.ecofy.ms_insights.core.domain.outbox.OutboxStatus.FAILED
    ...
    @Query("""
            select e
              from OutboxEventEntity e
             where e.status = br.com.ecofy.ms_insights.core.domain.outbox.OutboxStatus.PROCESSING
    ...
    @Query("""
            select count(e)
              from OutboxEventEntity e
             where e.status = br.com.ecofy.ms_insights.core.domain.outbox.OutboxStatus.DISCARDED
            """)
    long countDiscarded();
}
